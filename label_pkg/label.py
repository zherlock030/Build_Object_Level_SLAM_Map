...
class LabelMps(object):
    ...
    def init_memo(self):
        ...
        """
        try:
            self.memo = load_obj(os.path.join(self.label_path, 'memo'))
            print('we get memo')
        except:
            ...
            for m_id in range(len(self.mats)):
                ...
                if m_id > 10:
                    pass
            save_obj(self.memo, os.path.join(self.label_path, 'memo'))
    ...
    def statics(self):
        """show how many instances are clustered and how many map points are linked
        """
    ...
    def labeling(self):
        """the whole procdure of 
        """
        self.points, self.keyframe_set = init_mps(self.mp_path)
        ...
        self.statics()
        instance_labeling(self.instance_list, self.points)
